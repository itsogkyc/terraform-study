...
지금까지 테라폼 코드로 vpc, eks, helm chart 를 배포하는 과정을 알아보았습니다. 테라폼 코드를 사용하면 코드로 인프라를 관리할 수 있고, 재활용할 수 있으며 협업에도 용이한 툴이라는 것을 이번 학습을 통해 알게되었습니다. 양질의 강의 준비해주신 가시다님께 감사 인사 드립니다 ! 